...
1. Download Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe.asc and store the files in your Downloads folder.
...
7. Verify the installer binary:
    ...
    - Choose the Downloads\Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe file in the file dialog (the .asc signature file must reside in the same directory)
...
1. Download Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe.sha256 and store the files in your Downloads folder
2. Open a PowerShell window
3. Verify the checksums by copy/pasting the following commands:
    ```
    cd ~\Downloads
    $targetHash = (Get-Content -Path Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe.sha256 -Delimiter " ")[0].Trim()
    $fileName = (Get-Content -Path Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe.sha256 -Delimiter " ")[2].Trim()
...
4. The output of the command should equal:
    ```
    Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.exe: OK
    ```

## MacOS
### Verify File Authenticity
1. Download Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg.asc and store the files in your Downloads folder.
...
7. Verify the installer binary:
    - Right-click the Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg file in Finder (do NOT right click on the .asc file, that will not work), then select Services -> OpenPGP: Verify Signature of File (the .asc signature file must reside in the same directory)
...
### Verify File Integrity
1. Download Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg.sha256 and store the files in your Downloads folder
2. Open a Terminal window
3. Verify the checksums by copy/pasting the following command:
    ```
    cd ~/Downloads \
    && shasum -a256 -c Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg.sha256
    
    ```
4. The output of the command should equal:
    ```
    Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.dmg: OK
    ```

## Linux
### Verify File Authenticity
1. Download Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.deb and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.deb.asc and store the files in your Downloads folder for Debian based systems, or Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.AppImage and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.AppImage.asc and store the files in your Downloads folder for all other Linux systems.
...
6. Verify the installer binary using the .asc signature (the .asc signature file must reside in the same directory as the installer binary):
    ```
    cd ~/Downloads \
    && gpg2 --verify Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.*.asc
    ```
    - Successful verification should produce a message like follows:
    ```
    gpg: assuming signed data in 'Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.{extension}'
    ...
    ```
### Verify File Integrity
1. Download Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.deb and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.deb.sha256 and store the files in your Downloads folder for Debian based systems, or Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.AppImage and Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.AppImage.sha256 and store the files in your Downloads folder for all other Linux systems.
2. Open a Terminal window
3. Verify the checksums by copy/pasting the following command:
    ```
    cd ~/Downloads \
    && sha256sum -c Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.*.sha256
    
    ```
4. The output of the command should equal:
    ```
    Sphere_by_Horizen_Testnet-1.4.0-beta-testnet.{extension}: OK
    ```
